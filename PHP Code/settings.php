        ...
        <div class="card">
          ...
          <div class="card-body mrg_bottom">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#download_settings" aria-controls="download_settings" role="tab" data-toggle="tab">Download</a></li>
           ...
           <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="download_settings">
              <form action="" name="download_api" method="post" class="form form-horizontal" enctype="multipart/form-data" id="api_form">
                <div class="section">
                <div class="section-body">
                  <div class="form-group">
                    <label class="col-md-3 control-label">Song Dowload :-</label>
                    <div class="col-md-6">
                       
                      <select name="song_download" id="song_download" class="select2">
                  ...
                  <div class="form-group">
                  <div class="col-md-9 col-md-offset-3">
                    <button type="submit" name="download_submit" class="btn btn-primary">Save</button>
                  </div>
                  </div>
                </div>
                </div>
